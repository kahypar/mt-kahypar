...
namespace mt_kahypar::dyn {
    ...
    class V4 : public DynamicStrategy {
    ...
    private:
        ...
        void init_local_fm(ds::StaticHypergraph& hypergraph_s, Context& context) {
          ...
          if (context.dynamic.enable_refinement) {
    ...
    public:
        ...
        V4() : _benefit_aggregator(*new vec<Gain>()) {}
