...
#include "mt-kahypar/partition/initial_partitioning/flat/heavy_hyperedge_remover.h"
...
class RecursiveInitialPartitionerT : public IInitialPartitioner {
 private:
  ...
  using HeavyHyperedgeRemover = HeavyHyperedgeRemoverT<TypeTraits>;
  ...
  class RecursiveChildContinuationTask : public tbb::task {
   ...
   public:
    RecursiveChildContinuationTask(RecursivePartitionResult& result,
      ...
      _coarsener(nullptr),
      _heavy_he_remover(result.context, task_group_id),
      _result(result),
    ...
    tbb::task* execute() override {
      if ( _heavy_he_remover.isInitialized() ) {
        ...
        _heavy_he_remover.applyPartition(_coarsener->coarsestPartitionedHypergraph());
      }
   ...
   public:
    ...
    HeavyHyperedgeRemover _heavy_he_remover;
   ...
   public:
    ...
    tbb::task* execute() override {
      ...
      if ( _context.initial_partitioning.use_heavy_hyperedge_removal ) {
        ...
        child_continuation._heavy_he_remover.sparsify(child_continuation._coarsener->coarsestHypergraph());
        recursivePartition(child_continuation._heavy_he_remover.sparsifiedPartitionedHypergraph(), child_continuation);
      } else {
