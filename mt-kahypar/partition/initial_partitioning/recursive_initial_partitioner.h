 ...
 private:
  void initialPartitionImpl() override final {
    ...
    if (do_parallel_recursion) {
      ...
      tbb::parallel_invoke([&] {
          r1 = recursivePartition(num_threads_1, tbb_recursion_task_groups.first, 0);
        }, [&] {
          r2 = recursivePartition(num_threads_2, tbb_recursion_task_groups.second, 1);
        });
      ...
      best = recursivePartition(_context.shared_memory.num_threads, _task_group_id, 0);
    }
