...
export KAHYPAR="$HOME/kahypar/build/kahypar/application/KaHyPar"
...
export PATOH="$HOME/Downloads/patoh-Linux-x86_64/build/Linux-x86_64/patoh"
export METIS="$HOME/METIS/build/programs/gpmetis"
