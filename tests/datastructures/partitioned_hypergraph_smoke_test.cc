...
typedef ::testing::Types<TestConfig<PartitionedHypergraph<StaticHypergraph>,
                                    StaticHypergraph,
                                    StaticHypergraphFactory,
                                    TBBNumaArena,
                                    2, kahypar::Objective::cut>,
                        TestConfig<PartitionedHypergraph<StaticHypergraph>,
                                    StaticHypergraph,
                                    StaticHypergraphFactory,
                                    TBBNumaArena,
                        ...
                        TestConfig<NumaPartitionedHypergraph<NumaHyperGraph>,
                                    NumaHyperGraph,
