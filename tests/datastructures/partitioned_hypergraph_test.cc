...
TEST_F(ADynamicPartitionedHypergraph, ContainsCorrectNumberOfIncidentCutHyperedgesAfterUncontraction) {
  partitioned_hypergraph.resetPartition();
  hypergraph.registerContraction(1, 2);
  hypergraph.registerContraction(0, 1);
  hypergraph.registerContraction(4, 5);
  ...
  ASSERT_EQ(1, partitioned_hypergraph.numIncidentCutHyperedges(0));
  ASSERT_EQ(1, partitioned_hypergraph.numIncidentCutHyperedges(1));
  ASSERT_EQ(1, partitioned_hypergraph.numIncidentCutHyperedges(2));
  ASSERT_EQ(1, partitioned_hypergraph.numIncidentCutHyperedges(3));
  ASSERT_EQ(1, partitioned_hypergraph.numIncidentCutHyperedges(4));
  ASSERT_EQ(1, partitioned_hypergraph.numIncidentCutHyperedges(5));
  ASSERT_EQ(1, partitioned_hypergraph.numIncidentCutHyperedges(6));
}

TEST_F(ADynamicPartitionedHypergraph, ContainsCorrectNumberOfIncidentCutHyperedgesAfterRestoreParallelHEs) {
  partitioned_hypergraph.resetPartition();
  hypergraph.registerContraction(1, 2);
  hypergraph.registerContraction(0, 1);
  hypergraph.registerContraction(4, 5);
  ...
  auto removed_hes = hypergraph.removeSinglePinAndParallelHyperedges();
  VersionedBatchVector hierarchy = hypergraph.createBatchUncontractionHierarchy(2);
  ...
  partitioned_hypergraph.restoreSinglePinAndParallelNets(removed_hes);

  ASSERT_EQ(2, partitioned_hypergraph.numIncidentCutHyperedges(0));
  ASSERT_EQ(2, partitioned_hypergraph.numIncidentCutHyperedges(6));
